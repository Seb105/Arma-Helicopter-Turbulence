...
[
	"HELICOPTER_TURBULENCE_ENABLE_MASTER",
	"CHECKBOX",
	["Enable Turbulence","Enables turbulence system. Requires getting in & out of aircraft for change to take effect."],
	["Aircraft Turbulence","Helicopter Turbulence"],
	true,
	0
] call CBA_fnc_addSetting;
[
	"HELICOPTER_TURBULENCE_ENABLE_WEATHEREFFECT",
	"CHECKBOX",
...
[
	"HELICOPTER_TURBULENCE_MIN_TURBULENCE",
	"SLIDER",
...
[
	"HELICOPTER_TURBULENCE_MAX_TURBULENCE",
	"SLIDER",
